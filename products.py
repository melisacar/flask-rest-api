...
# In the terminal, run the following command to add a product to the list. 
# This will be a POST request to which you will pass the product parameter as a JSON.

#curl -X POST -H "Content-Type: application/json" \
#    -d '{"id": 145, "name": "Pen", "price": 2.5}' \
#    http://localhost:5000/products
# or
# C:\Windows\System32\curl.exe -X POST "http://localhost:5000/products" `
